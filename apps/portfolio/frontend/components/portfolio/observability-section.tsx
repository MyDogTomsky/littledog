...
export function ObservabilitySection() {
  ...
  return (
    <section id="live-demo" className="pt-32 pb-20 px-6 bg-card/30">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <Badge variant="outline" className="mb-4 border-cyan-500/50 text-cyan-400 bg-cyan-500/10">
            Live Demo
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Live System Demo</h2>
        ...
        <div className="mt-16">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold mb-2">Weather API Integration</h3>
